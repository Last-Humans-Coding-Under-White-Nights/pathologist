...
| LineMap macro provenance | Replacement tokens retain definition spelling, outermost invocation coordinates, and a deterministic fingerprint of nested invocation and parameter-substitution steps; cache splice and spill/reload preserve all three |
